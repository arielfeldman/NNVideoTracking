...
def visualize_boxes_and_labels_on_image_array(
  ...
  for i in range(min(max_boxes_to_draw, boxes.shape[0])):
    if scores is None or scores[i] > min_score_thresh:
      ...
      if class_name=='interacting rat':
        intercoords=box
      elif class_name=='median':
        medcoords=box
      # print('interacting coordinates:', intercoords)
      # print('median coordinates:', medcoords)
      if (len(intercoords)==4) and (len(medcoords)==4):
        if intercoords[1] <= medcoords[1]:
          if intercoords[3] < medcoords[3]:
            lobject+=1
        elif intercoords[3] >= medcoords[3]:
          robject +=1
  # print('left object', lobject)
  # print('right object', robject)
